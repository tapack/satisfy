...
public final class SatisfyAnnotatedStepDescription {
    ...
    private static final List<String> VALID_STEP_ANNOTATIONS = ImmutableList
    ...
    private void addMultipleRequirementsFrom(final List<String> requirements,
    ...
    private void addRequirementFrom(final List<String> requirements, final
    Method testMethod) {
    ...
    private Optional<String> getAnnotatedStepName() {
        Optional<String> stepAnnotatedName = getNameFromStepAnnotationIn
                (getTestMethod());
